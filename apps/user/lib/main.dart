...
Future<void> main() async {
  ...
  // ✅ Web: desliga Firebase por enquanto (o pacote veio com configs antigas e conflitantes).
  // ✅ Mobile: Firebase auto-configura via google-services.json / GoogleService-Info.plist (Lokally).
